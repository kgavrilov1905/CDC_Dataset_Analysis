...
```
```{r ggplotObsPhysAge}
ggplot(data = total) + geom_point(mapping = aes(x = Data_Value47, y = Data_Value36, color = Age)) + 
...
```{r ggplotObsFruitAge}
ggplot(data = total) + geom_point(mapping = aes(x = Data_Value18, y = Data_Value36, color = Age)) + 
...
```{r ggplotObsPhysRace}
ggplot(data = total) + geom_point(mapping = aes(x = Data_Value47, y = Data_Value36, color = Race.Ethnicity)) + 
...
ggplot(data = total) + geom_point(mapping = aes(x = Data_Value18, y = Data_Value36, color = Race.Ethnicity)) +
  ggtitle("Obesity Rates vs Fruit Intake for Different Age Groups") + xlab("% of adults with consume fruit less than one time a day") + ylab("% of adults who have obesity")
```
