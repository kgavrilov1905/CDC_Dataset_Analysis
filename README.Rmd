...
Cross validation was carried out to further assess the performance of the model. Even though the R-squared value of the current model is 0.2965, mean prediction error turned out to be 20.86% for the percent of adults who have obesity. 
```{r echo = FALSE}
set.seed(123)
